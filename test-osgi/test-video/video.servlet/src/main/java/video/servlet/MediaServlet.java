...
public class MediaServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 4937549770925687787L;

    private static final int DEFAULT_BUFFER_SIZE = 1024 * 1024; // ..bytes = 1MB.
    ...
    public MediaServlet(String basePath) {
...
//                    else if (end == -1) {
//                        end = min(start + DEFAULT_BUFFER_SIZE-1, length-1);
//                    }
        ...
        System.out.println(fileName + ":-) " + ranges);
    ...
    protected class Range {
        ...
        public String toString() {
            return "Range [start=" + start + ", end=" + end + ", length="
                    + length + ", total=" + total + "]";
        }
